...
if authentication_status:
    ...
    if selected == "Home":
        ...
        if name == "Carter Brubaker":
            ...
            if button:
                db.insert_overall(date_time, XC_Men_Overall)
                db.insert_overall(date_time, XC_Women_Overall)
                db.insert_overall(date_time, Jump_Men_Overall)
                db.insert_overall(date_time, Jump_Women_Overall)
                db.insert_overall(date_time, NoCo_Men_Overall)
                db.insert_overall(date_time, NoCo_Women_Overall)
